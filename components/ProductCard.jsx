  ...
  return (
    <div className="border border-gray-200 rounded-lg shadow-md p-4 max-w-md mx-auto hover:shadow-lg transition-shadow mb-10">
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-400 transition-colors" onClick={()=>handleCartClick(product)}>
          Add to Cart
        </button>
      </div>
    </div>
